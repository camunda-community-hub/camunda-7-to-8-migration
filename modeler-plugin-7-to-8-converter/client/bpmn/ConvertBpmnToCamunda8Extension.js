...
import ConvertToCamunda8Plugin from '../ConvertToCamunda8PluginIndex';
 ...
 *
 */
export default class ConvertBpmnToCamunda8Extension extends PureComponent {
  ...
  constructor(props) {
    ...
    subscribe('bpmn.modeler.configure', (event) => {
      ...
      middlewares.push(addModule(ConvertToCamunda8Plugin));
    });
