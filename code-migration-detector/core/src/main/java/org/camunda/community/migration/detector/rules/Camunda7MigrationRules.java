...
public class Camunda7MigrationRules {
	...
	public static ArchRule ensureNoSpringEventTaskListeners() {
		return ArchRuleDefinition.noClasses().should(new HasMethod(new IsSpringListener<>(DelegateTask.class)));
	}

	public static ArchRule ensureNoSpringEventExecutionListeners() {
		return ArchRuleDefinition.noClasses().should(new HasMethod(new IsSpringListener<>(DelegateExecution.class)));
	}

	public static ArchRule ensureNoSpringEventHistoryEventListeners() {
		return ArchRuleDefinition.noClasses().should(new HasMethod(new IsSpringListener<>(HistoryEvent.class)));
	}
