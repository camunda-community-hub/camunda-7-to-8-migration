...
public class SimpleJavaApiCallingService {
	...
	public SimpleJavaApiCallingService(RuntimeService runtimeService, CaseService caseService,
			DecisionService decisionService, ManagementService managementService, IdentityService identityService,
			FormService formService, ExternalTaskService externalTaskService, TaskService taskService,
			RepositoryService repositoryService, FilterService filterService) {
