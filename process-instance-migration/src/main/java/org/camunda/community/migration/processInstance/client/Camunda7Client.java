...
import org.camunda.community.migration.processInstance.dto.HistoricActivityInstanceDto.HistoricActivityInstanceQueryResultDto;
import org.camunda.community.migration.processInstance.dto.HistoricVariableInstanceDto;
import org.camunda.community.migration.processInstance.dto.HistoricVariableInstanceDto.HistoricVariableInstanceQueryResultDto;
import org.camunda.community.migration.processInstance.dto.ProcessDefinitionDto;
import org.camunda.community.migration.processInstance.dto.ProcessDefinitionDto.ProcessDefinitionQueryResultDto;
import org.camunda.community.migration.processInstance.dto.ProcessInstanceDto;
import org.camunda.community.migration.processInstance.dto.ProcessInstanceDto.ProcessInstanceQueryResultDto;
import org.camunda.community.migration.processInstance.dto.VariableInstanceDto;
import org.camunda.community.migration.processInstance.dto.VariableInstanceDto.VariableInstanceQueryResultDto;
import org.camunda.community.migration.processInstance.dto.VariableValueDto;
...
public class Camunda7Client {
  ...
  private static final String QUERY_VARIABLE_INSTANCE =
      "/variable-instance?processInstanceIdIn={processInstanceId}";
  ...
  private static final String PROCESS_DEFINITION_LATEST_BY_KEY =
      "/process-definition?latestVersion=true&key={processDefinitionKey}";
  ...
  public void testConnection() {
    if (properties.getCheckOnInit()) {
      try {
        Camunda7VersionDto version = getVersion();
