...
public class ExternalTaskHandlerWrapperTest {
  ...
  public void shouldResolveVariables() {
    ...
    ActivatedJob job = new ActivatedJobImpl(
    ...
    ExternalTaskHandlerWrapper wrapper = new ExternalTaskHandlerWrapper((externalTask, externalTaskService) -> {
  ...
  private static String loadVariableContent() {
    try {
      return Resources.toString(Resources.getResource("test-variables.json"), Charset.defaultCharset());
    } catch (Exception e) {
